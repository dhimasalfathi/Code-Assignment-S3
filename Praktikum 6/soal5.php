<?php
  ...
  $rawstring = "Welcome Birmingham parent! <br> Your offspring is a pleasure to have! We believe pronoun is learning a lot.<br> The faculty simple adores gender and you can often hear them say \"Attah sex!\"<br>";

  //placeholders array
  $placeholders = array('offspring', 'pronoun', 'gender', 'sex');
